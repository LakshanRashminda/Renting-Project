...
const MakeReservationScreen = () => {
    ...
    try {
      ...
      const { data } = await Axios.post(
        '/api/reservations',
        {
          ...
          returnOption: rentCart.returnOption,
        },
        {
          headers: {
  ...
  return (
    <div>
      ...
      <Helmet>
        <title>Preview Reservation</title>
      </Helmet>
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              <Link to="/pickuplocation">
                <button className="mt-3 btn btn-outline-secondary">Edit</button>
              </Link>
            </Card.Body>
          </Card>
          <Card className="mb-3">
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  <Row>
                    ...
                    <Col>
                      <strong>{rentCart.totalPrice.toFixed(2)}LKR</strong>
                    </Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <div className="d-grid">
                    <Button
                      ...
                      disabled={rentCart.rentCartItems.length === 0}
                    >
                      Make Reservation
                    </Button>
